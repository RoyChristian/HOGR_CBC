...
#                                 run Stan model
################################################################################
full.model <- cmdstan_model(stan_file=file.path(root,"stan","sst_linear_only.stan"))
...
#                                 save output
################################################################################
save.image(file.path(root, paste0("output/linear_only/linear_only_", (nrow(mean.ordered)-Kept_out), ".RData")))
fit$save_object(file = file.path(root, paste0("output/linear_only/fit_linear_only_N", (nrow(mean.ordered)-Kept_out), "fit.RDS")))
...
################################################################################
#                      extract lpp for observed values
################################################################################
...
write.csv(pred.df, file = file.path(root, paste0("output/linear_only/fit_linear_only_N", (nrow(mean.ordered)-Kept_out), "lppd.csv")), row.names = FALSE)